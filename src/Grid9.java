...
public class Grid9 extends JPanel implements MouseListener, Grid {
	
	private static final long serialVersionUID = -4430740186607055916L;
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (e.getX() > 184 && e.getX() < 504 && e.getY() > 36 && e.getY() < 644){ /* The Grid */
			x = (e.getX() - 184) /32;
			y = (e.getY() - 36) /32;
		}
