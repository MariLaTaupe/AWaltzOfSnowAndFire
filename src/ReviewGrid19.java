...
public class ReviewGrid19 extends JPanel implements MouseListener, ReviewGrid {

	private static final long serialVersionUID = 9162139346414582401L;
	...
	public void paintComponent(Graphics g){
		...
		g.drawRect(455, 679, 65, 17);
		g.setColor(Color.green);
		g.fillRect(456, 680, 64, 16);
		g.setColor(Color.white);
		g.drawString(str3, 469, 693);
	}
	...
	public void mouseClicked(MouseEvent e){
		...
		if (e.getX() > 456-1 && e.getX() < 456+65 && e.getY() > 685-1 && e.getY() <685+17){ /* The third button */
			x = 0;
		}
